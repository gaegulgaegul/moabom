...
### 작업 내용
- [x] **RED**: 누락된 컴포넌트 클래스 테스트 ✅ 2025-12-16
- [x] **GREEN**: `app/assets/tailwind/application.css`에 추가 ✅ 2025-12-16
...
- [x] **REFACTOR**: 클래스 정리 및 최적화 ✅ 2025-12-16

### 완료 기준
- ✅ 모든 디자인 시스템 클래스 사용 가능
- ✅ `rails tailwindcss:build` 성공
- ✅ 모든 테스트 통과 (278 runs, 0 failures)
